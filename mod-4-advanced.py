...
def relationship_status(from_member, to_member, social_graph):
    ...
    elif to_member in from_following and from_member not in to_following:
        return "follower"
    
    elif to_member not in from_following and from_member in to_following:
        return "followed by"
    else:
...
def tic_tac_toe(board):
   ...
   for row in board:
    ...
    elif len(set([board[2-i][i] for i in range(len(board))])) == 1 and board[2-0][0] != "":
        return board[2-0][0]
...
def eta(first_stop, second_stop, route_map):
    ...
    for i in route_map:
        ...
        first_destinations = [i[0] for i in destinations]
        second_destinations = [i[1] for i in destinations]

        final_first = first_destinations.index(first_stop)
        final_second = second_destinations.index(second_stop)
